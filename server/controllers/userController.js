...
const getUserProfile = async (req, res) => {
  try {
    ...
    console.log(
      "DEBUG getUserProfile: lastLogin =",
      user.lastLogin,
      "formattedLastLogin =",
  ...
  try {
    ...
    const results = testCases.map((testCase) => {
      ...
      return {
        ...
        lastLogin: user.lastLogin,
        diffInHours: user.lastLogin
          ? Math.floor((now - user.lastLogin) / (1000 * 60 * 60))
          : null,
